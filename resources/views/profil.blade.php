  ...
  <div class="row mt-5">
    <div class="col-lg-12">
      <div class="grid text-center">
        ...
        <h2 class="judul">Informasi Sekolah</h2>

        <table class="table table-bordered border-primary">
          <tbody>
          <tr>
            <td>Nama Sekolah <br>SMKN 4 Tasikmalaya</td>
            <td>NPSN <br> 20276063</td>
          </tr>
          <tr>
            <td>Nomor Statistik Sekolah <br> 401327810004</td>
            <td>Alamat <br> Jalan Depok RT 02 RW 05</td>
          </tr>
          <tr>
            <td>Telepon <br> +(62)265312059</td>
            <td>Email <br> info@smkn4tsm.sch.id</td>
          </tr>
          </tbody>
        </table>
      </div>
...
<div class="container">
  ...
  <div class="row mt-5 text-center">
    <div class="col-lg-12">
      <h2 class="judul">Visi & Misi SMKN 4 Tasikmalaya</h2>
          <div class="card">
            <div class="card-body bg-light">
              <h2>Visi :</h2>
              <p>"TERWUJUDNYA LULUSAN YANG CERDAS, AKTIF, KOMPETITIF, ADAPTIF DAN PRODUKTIF BERLANDASKAN IMAN DAN TAQWA"</p>
            </div>
            <div class="card-body bg-light">
              <h2>Misi :</h2>
              <p>

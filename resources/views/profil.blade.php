...
<div class="container">
  ...
  <div class="row mt-5">
    <div class="col-lg-12">
      <div class="grid text-center">
        ...
        <h2 class="text-center bg-primary-subtle">Identitas Sekolah</h2>

        <div class="row justify-content-center">
          <!-- card 1 -->
          <div class="col-lg-6">
            <div class="card mb-3 bg-light" style="max-width: 800px;">
              <div class="row g-0 px-3">
                <div class="col-md-9 ">
                  <div class="card-body">
                    <h5 class="card-title text-start">Nama Sekolah</h5>
                    <p class="card-text text-start">SMKN 4 Tasikmalaya</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card mb-3 bg-light" style="max-width: 800px;">
              <div class="row g-0 px-3">
                <div class="col-md-9">
                  <div class="card-body">
                    <h5 class="card-title text-start">NPSN</h5>
                    <p class="card-text text-start">20276063</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card mb-3 bg-light" style="max-width: 800px;">
              <div class="row g-0 px-3">
                <div class="col-md-9">
                  <div class="card-body">
                    <h5 class="card-title text-start">Nomor Statistik Sekolah</h5>
                    <p class="card-text text-start">401327810004</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row g-0 px-3">
                <div class="col-md-9">
                  <div class="card-body">
                    ...
                    <p class="card-text text-start">Jalan Depok RT 02 RW 05</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row g-0 px-3">
                <div class="col-md-9">
                  <div class="card-body">
                    ...
                    <p class="card-text text-start">+(62)265312059</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row g-0 px-3">
                <div class="col-md-9">
                  <div class="card-body">
                    ...
                    <p class="card-text text-start">info@smkn4tsm.sch.id</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="row mt-5 text-center">
    <div class="col-lg-12">
      <h2 class="bg-primary-subtle">Sejarah</h2>
          <div class="card">
  ...
  <div class="row mt-5 text-center">
    <div class="col-lg-12">
      <h2 class="bg-primary-subtle">Visi & Misi SMKN 4 Tasikmalaya</h2>
          <div class="card">
            <div class="card-body bg-light">
              <h2>Visi :</h2>

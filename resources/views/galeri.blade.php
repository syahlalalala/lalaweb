    ...
    <div class="row mt-5">
        <div class="col-lg-12 text-center rounded">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-4 mt-3">
                    <img src="https://lh3.googleusercontent.com/pw/AP1GczNYNn2lImNNgIwMgFJdrP-xre00E4rOEpVdseBnRB4P70fz8G1x2e1IM8M6A_Tywmh4wadSjGMfjVP5CEzBHWd2Q2dOCH-0ryA6vc1BqNHIoGO6T7nn-mbqNmF_vmUZN1xaVoJLdF0GDueI1rilUrlM=w1680-h945-s-no-gm?authuser=0" width="100%" alt="">
                </div>
            </div> 
        </div>
    </div>
